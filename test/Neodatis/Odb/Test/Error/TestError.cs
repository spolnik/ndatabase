...
namespace Test.Odb.Test.Error
{
    ...
    public class TestError : ODBTest
	{
		...
		{
			NDatabaseError e = new NDatabaseError(0, "x @1 y"
				);
		...
		{
			NDatabaseError e = new NDatabaseError(0, "x @1 @2 @3 @5 y"
				);
		...
		{
			NDatabaseError e = new NDatabaseError(0, "x y");
			e.AddParameter("param1");
			e.AddParameter("param2");
			e.AddParameter("param3");
			e.AddParameter("param4");
		...
		{
			NDatabaseError e = new NDatabaseError(12, "x @1 @2 @3 @5 y"
				);
