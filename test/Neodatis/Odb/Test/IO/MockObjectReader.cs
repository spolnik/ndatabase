...
namespace IO
{
    public class MockObjectReader : IObjectReader
    {
        ...
        public AttributeValuesMap ReadObjectInfoValuesFromOID(ClassInfo classInfo, OID oid, bool useCache, IOdbList<string> attributeNames, IOdbList<string> relationAttributeNames, int recursionLevel, string[] orderByFields)
        {
            return null;
        }
