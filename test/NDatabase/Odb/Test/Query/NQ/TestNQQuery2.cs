...
namespace Test.NDatabase.Odb.Test.Query.NQ
{
    ...
    public class TestNqQuery2 : ODBTest
    {
        ...
        internal sealed class SimpleNativeQuery70 : SimpleNativeQuery<VO.Login.Function>
        {
        ...
        internal sealed class SimpleNativeQuery89 : SimpleNativeQuery<VO.Login.Function>
        {
            public override bool Match(VO.Login.Function function)
            {
        ...
        internal sealed class SimpleNativeQuery121 : SimpleNativeQuery<User>
        {
            public override bool Match(User user)
            {
