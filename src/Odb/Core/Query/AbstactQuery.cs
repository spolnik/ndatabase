...
{
	[System.Serializable]
	public abstract class AbstactQuery : NeoDatis.Odb.Core.Query.IQuery
	{
		...
		/// <summary>The OID attribute is used when the query nust be restricted the object with this OID
		/// 	</summary>
			...
			()
		{
			...
			{
				throw new NeoDatis.Odb.ODBRuntimeException(NeoDatis.Odb.Core.Error.ExecutionPlanIsNullQueryHasNotBeenExecuted
					);
			}
