namespace NDatabase.Odb.Core.Transaction
{
    ...
    {
        /// <summary>
        ///   Associates the specified <see cref="OID">NDatabase.Odb.OID</see> with the specified object(key) in this cache
        /// </summary>
        /// <param name="object"> The key. This parameter can not be <code>null</code> </param>
        /// <param name="oid"> </param>
        void AddObject(object @object, OID oid);
        ...
        ///   Removes the mapping for this object from this cache if it is present.
        /// </remarks>
        /// <param name="object"> that contains the reference to <see cref="OID">NDatabase.Odb.OID</see> . This parameter can not be <code>null</code> </param>
        ...
        ///   Mark the object with the oid as deleted.
        /// </remarks>
        /// <param name="oid"> that must be marked as deleted. <pre>When objects are deleted by oid, the cost is too high to search the object by the oid, so we just keep the deleted oid,
        ///                                                      and when looking for an object, check if the oid if is the deleted oids</pre> </param>
        ...
        /// <summary>
        ///   Return the specific <see cref="OID">NDatabase.Odb.OID</see>
        /// </summary>
        /// <param name="object"> The key on the cache for a <see cref="OID">NDatabase.Odb.OID</see> . This parameter can not be <code>null</code> </param>
        /// <returns> <see cref="OID">NDatabase.Odb.OID</see> . Returns <code>null</code> in case no find key. </returns>
