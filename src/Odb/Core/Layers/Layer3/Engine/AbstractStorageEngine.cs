...
namespace NDatabase.Odb.Core.Layers.Layer3.Engine
{
    ...
    /// </remarks>
    public abstract class AbstractStorageEngine : AbstractStorageEngineReader
    {
        ...
        /// </summary>
        protected AbstractStorageEngine(IBaseIdentification parameters)
        {
        ...
        public abstract override ClassInfoList AddClasses(ClassInfoList arg1);

        public abstract override ISession BuildDefaultSession();

        public abstract override IObjectIntrospector BuildObjectIntrospector();

        public abstract override IObjectReader BuildObjectReader();

        public abstract override IObjectWriter BuildObjectWriter();

        public abstract override ITriggerManager BuildTriggerManager();
        ...
        /// </summary>
        /// <remarks>
        ///   Store an object in ODBFactory database. <pre>Transforms the object into meta representation and calls the internalStoreObject</pre>
        /// </remarks>
        /// <param name="object"> </param>
        /// <returns> The object insertion position </returns>
        /// <exception cref="System.IO.IOException">System.IO.IOException</exception>
        protected virtual OID InternalStore(object @object)
        {
        ...
        /// <param name="object"> </param>
        protected virtual OID InternalStore(OID oid, object @object)
        {
