...
namespace NDatabase.Odb.Core.Layers.Layer1.Introspector
{
    ...
    internal static class ClassIntrospector
    {
        ...
        public static Object NewInstanceOf(Type clazz)
        {
            ...
            var constructor = clazz.GetTypeInfo().DeclaredConstructors.FirstOrDefault(x => !x.GetParameters().Any());
            ...
            var constructors =
                clazz.GetTypeInfo().DeclaredConstructors.ToArray();
