...
namespace NDatabase.UnitTests.Layer3
{
    public class When_we_use_multi_buffer_vo : InstanceSpecification<IMultiBuffer>
    {
        ...
        protected override void Establish_context()
        {
            ...
            _buffer2StartPosition = 2L;
            _buffer2EndPosition = 20L;
            _creationDate2 = OdbTime.GetCurrentTimeInTicks() + 2;

            _buffer3StartPosition = 3L;
            _buffer3EndPosition = 30L;
            _creationDate3 = OdbTime.GetCurrentTimeInTicks() + 3;

            _buffer4StartPosition = 4L;
            _buffer4EndPosition = 40L;
            _creationDate4 = OdbTime.GetCurrentTimeInTicks() + 4;

            _buffer5StartPosition = 5L;
            _buffer5EndPosition = 50L;
